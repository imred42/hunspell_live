(an)
Diccionario ortografico aragonés.
Versión 0.2. (beta)
...
Copyright (c) 2011 Juan Pablo Martínez (jpmart<at>unizar<dot>es)
   ...
   * LGPL : GNU Lesser General Public License
   ...
   A versión 0.2 d'o listau de parolas s'ha elaborau emplegando corpus libres como a Wikipedia 
   en aragonés (http://an.wikipedia.org), y listas de parolas obtenidas d'os diccionarios d'Apertium 
   (http://apertium.svn.sourceforge.net/viewvc/apertium/tags/apertium-es-an/release-2.0/).

   As sucherencias y realimentación sobre o diccionario ortografico son bienplegadas.
   ...
   Nota: A ortografía emplegada ye a proposada por l'Academia de l'Aragonés - Estudio de Filolochía Aragonesa. 
...
Copyright (c) 2011 Juan Pablo Martínez (jpmart<at>unizar<dot>es)
   ...
   * LGPL : GNU Lesser General Public License
   ...
   Note: The spelling system for aragonés can be found at: http://www.academiadelaragones.org/biblio/EDACAR7_2.pdf
